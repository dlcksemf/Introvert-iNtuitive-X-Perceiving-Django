# Generated by Django 3.2.12 on 2022-02-16 12:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(blank=True, upload_to='books/%Y/%M')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_state', models.CharField(choices=[('L', 'Loaned'), ('P', 'Pending'), ('R', 'Returned'), ('O', 'Overdue')], max_length=1)),
                ('book_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='loaned_books', to='books.books')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '도서 대출',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('application_num', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(db_index=True, max_length=100)),
                ('writer', models.CharField(db_index=True, max_length=100)),
                ('publisher', models.CharField(max_length=100)),
                ('ISBN', models.CharField(db_index=True, max_length=20)),
